  ...
  return (
    <div className="success">
      <div className="success_icon">
        <div className="check check--success">
      ...
      <div className="success_inner">
        ...
        <p className="success_text">
          Номер заявления RU-1234567. Максимальный срок предоставления услуги —
          20 рабочих дней. Следите за статусом заявления в{" "}
        ...
        <div className="success_btn">
          <Button style={styleMiddleBtn} type="primary">
            Вернуться в каталог
          </Button>
